...
namespace CIN_CITY.Views
{
    ...
    // Wrapper class to display the html which provides help information about the App
    public partial class HelpPage : ContentPage
    {
        public HelpPage()
        {
            ...
            Stream stream = assembly.GetManifestResourceStream("CIN_CITY.HTML.help.html");
            string source = "";
